-- ============================================================
-- Blog CMS Database Schema — Chandigarh University Online
-- Database: u261758575_cu1 (Hostinger)
...
('CU Online Team', 'Official content team of Chandigarh University Online, keeping you updated with the latest in online education.', 1);
...
('University News', 'university-news', 'Chandigarh University updates, achievements and announcements');
