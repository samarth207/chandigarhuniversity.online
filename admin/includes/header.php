...
<title><?= htmlspecialchars($pageTitle) ?> — CU Blog CMS</title>
...
<aside class="admin-sidebar" id="adminSidebar">
    <div class="sidebar-brand">
        <div class="brand-logo">
            <img src="/assets/uploads/favicon.png" alt="CU Online" onerror="this.style.display='none'">
            <div>
                <div class="brand-name">CU Blog CMS</div>
