...
<title>Admin Login — CU Blog CMS</title>
...
<div class="login-wrapper">
    <div class="login-card">
        <div class="login-logo">
            <img src="/assets/images/cu-logo.webp" alt="Chandigarh University Online" onerror="this.style.display='none'">
            <h1>CU Blog CMS</h1>
            <p>Admin Panel · Chandigarh University Online</p>
        </div>
    ...
    <div class="back-to-site">
        <a href="/"><i class="fas fa-home"></i> chandigarhuniversity.online</a>
    </div>
</div>
